...
Public Class TabPage
    ...
    Friend MenuItem As New MenuItem
    ...
    Private m_FormIsShown As Boolean = False
    Private Sub m_Form_FormShown(ByVal sender As Object, ByVal e As EventArgs) Handles m_Form.Shown
        m_FormIsShown = True
    End Sub
    Private Sub m_Form_Disposed(ByVal sender As Object, ByVal e As EventArgs) Handles m_Form.Disposed
        If Not m_FormIsShown And Me.Parent IsNot Nothing Then
    ...
    Private Sub Tab_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        ...
        If e.Button = Windows.Forms.MouseButtons.Left Then
            ...
            If MouseOverCloseButton And m_CloseButtonVisible Then
                MainApplication.lockedFromMoving = True
    ...
    Private Sub Tab_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MouseEnter
        MainApplication.updateTabPreview(Me)
    ...
    Public Sub DrawIcon(ByVal g As Graphics)
        Try
    ...
    Private Function GetRegion(ByVal W As Integer, ByVal H As Integer, ByVal H1 As Integer) As Point()
        ...
        Dim R() As Point = {New Point(0, H), New Point(0, 0), New Point(0, 0), New Point(W, 0), New Point(W, 0), New Point(W, H)}
