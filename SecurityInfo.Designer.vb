...
Partial Class SecurityInfo
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Document Protocol: Loading..."
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Security State: Loading..."
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Image Count: Loading..."
        '
        'SecurityInfo
        '
        ...
        Me.Name = "SecurityInfo"
        Me.ShowIcon = False
        Me.ShowInTaskbar = False
        Me.Text = "Security Information"
        Me.TopMost = True
