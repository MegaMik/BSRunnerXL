...
#Region " Class TabPageCollection "
    ...
    Public Class TabPageCollection
        ...
        Private Sub TabPage_Clicked(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If TabControl.SelectedForm.tpName = "BrowserApplication" Then
                If MainApplication.TabControl1.SelectedForm.getURLHook().StartsWith("file:///") And MainApplication.TabControl1.SelectedForm.getTitleHook() = "You have opened a new tab" Then
                    MainApplication.TabControl1.SelectedForm.FocusTextboxHook()
                Else
...
#End Region
    ...
    Public Sub pnlTop_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles pnlTop.Paint
...
#End Region
    ...
    Private Sub pnlTop_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTop.MouseMove
        If MainApplication.lockedFromMoving = False Then
            If e.Button = MouseButtons.Left Then
                If MainApplication.WindowState = FormWindowState.Normal Then
                    MainApplication.pnt = MainApplication.MousePosition
                    MainApplication.pnt.X = MainApplication.pnt.X - MainApplication.X
                    MainApplication.pnt.Y = MainApplication.pnt.Y - MainApplication.Y
                    MainApplication.Location = MainApplication.pnt
                    If MousePosition.X <= 0 Then
                        MainApplication.ASF.showMe(AeroSnapForm.showMode.Half_Left)
                    ElseIf MousePosition.X >= My.Computer.Screen.WorkingArea.Width - 1 Then
                        MainApplication.ASF.showMe(AeroSnapForm.showMode.Half_Right)
                    ElseIf MousePosition.Y <= 0 Then
                        MainApplication.ASF.showMe(AeroSnapForm.showMode.All_Max)
                    Else
                        MainApplication.ASF.hideMe()
                    End If
                End If
            End If
        End If
    ...
    Private Sub pnlTop_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTop.MouseDown
        MainApplication.lockedFromMoving = False
        If MainApplication.WindowState = FormWindowState.Normal Then
            MainApplication.X = MainApplication.MousePosition.X - MainApplication.Location.X
            MainApplication.Y = MainApplication.MousePosition.Y - MainApplication.Location.Y
        End If
    End Sub

    Private Sub pnlTabs_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseMove
        If MainApplication.lockedFromMoving = False Then
            If e.Button = MouseButtons.Left Then
                If MainApplication.WindowState = FormWindowState.Normal Then
                    MainApplication.pnt = MainApplication.MousePosition
    ...
    Private Sub pnlTabs_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseDown
        MainApplication.lockedFromMoving = False
        If MainApplication.WindowState = FormWindowState.Normal Then
            MainApplication.X = MainApplication.MousePosition.X - MainApplication.Location.X
            MainApplication.Y = MainApplication.MousePosition.Y - MainApplication.Location.Y
    ...
    Private Sub pnlTop_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTop.MouseUp
        If MainApplication.ASF.isEstablished = True Then
            MainApplication.ASF.hideMe()
            If MainApplication.ASF.currentMode = AeroSnapForm.showMode.Half_Left Then
                MainApplication.Location = My.Computer.Screen.WorkingArea.Location
                MainApplication.Size = New System.Drawing.Size(My.Computer.Screen.WorkingArea.Width / 2, My.Computer.Screen.WorkingArea.Height)
            ElseIf MainApplication.ASF.currentMode = AeroSnapForm.showMode.Half_Right Then
                MainApplication.Location = New System.Drawing.Point(My.Computer.Screen.WorkingArea.Width / 2, My.Computer.Screen.WorkingArea.Y)
                MainApplication.Size = New System.Drawing.Size(My.Computer.Screen.WorkingArea.Width / 2, My.Computer.Screen.WorkingArea.Height)
            Else
    ...
    Private Sub pnlTabs_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseUp
        If MainApplication.ASF.isEstablished = True Then
            MainApplication.ASF.hideMe()
            If MainApplication.ASF.currentMode = AeroSnapForm.showMode.Half_Left Then
                MainApplication.Location = My.Computer.Screen.WorkingArea.Location
