...
Friend Class ControlButton
    ...
    Private Sub MdiTab_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs)
        m_hot = True
        Invalidate()
    End Sub

    Private Sub MdiTab_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs)
        m_hot = False
        Invalidate()
    End Sub
